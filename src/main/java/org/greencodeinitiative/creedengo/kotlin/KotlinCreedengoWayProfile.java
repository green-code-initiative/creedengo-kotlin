...
import static org.greencodeinitiative.creedengo.kotlin.KotlinRulesDefinition.LANGUAGE;
import static org.greencodeinitiative.creedengo.kotlin.KotlinRulesDefinition.REPOSITORY_KEY;

public class KotlinCreedengoWayProfile implements BuiltInQualityProfilesDefinition {
    static final String PROFILE_NAME = "creedengo way";
    static final String PROFILE_PATH = KotlinCreedengoWayProfile.class.getPackageName().replace('.', '/') + "/creedengo_way_profile.json";
